var express = require('express'),
	...
	io      = require('socket.io')(server),			//entienda peticiones de tipo socket.io
...
app.use(express.static(__dirname));				//acceso a estaticos
...
io.sockets.on('connection', function(socket){					// TODO DE SOCKET.IO   
